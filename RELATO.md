...
**22/09 15:20 vigia da esteira (ALARME)** -- trava A (estrutural) vazia: nenhuma fatia viva, nova ou para relancar na fila.


**22/09 15:35 vigia da esteira (ALARME)** -- a fatia k8_golive esta PRONTA ha 72 min e nao esta na fila de integracao: trabalho terminado que ninguem vai buscar. Se ela tem portao, o fatia.done tem de DIZER qual; se nao tem, reentregue com bin/entregar.sh..


**22/09 15:35 vigia da esteira** -- vigia relancou k8_golive as 15:35 (baseline divergiu: a arvore andou depois do teste da fatia). Para a admin: nada muda.


**22/09 15:40 vigia da esteira (ALARME)** -- a fatia score_fmcomp esta PRONTA ha 73 min e nao esta na fila de integracao: trabalho terminado que ninguem vai buscar. Se ela tem portao, o fatia.done tem de DIZER qual; se nao tem, reentregue com bin/entregar.sh..


**22/09 15:40 vigia da esteira** -- vigia relancou score_fmcomp as 15:40 (baseline divergiu: a arvore andou depois do teste da fatia) -- E O RELANCE NAO PEGOU. Para a admin: nada muda.


**22/09 15:45 vigia da esteira (ALARME)** -- a fatia score_fmcomp caiu por vermelho DELA (construir falhou) -- nao relanco.


**22/09 15:50 vigia da esteira (ALARME)** -- a fatia k8_gerar_alertas esta PRONTA ha 41 min e nao esta na fila de integracao: trabalho terminado que ninguem vai buscar. Se ela tem portao, o fatia.done tem de DIZER qual; se nao tem, reentregue com bin/entregar.sh..


**22/09 15:50 vigia da esteira** -- vigia relancou k8_gerar_alertas as 15:50 (baseline divergiu: a arvore andou depois do teste da fatia) -- E O RELANCE NAO PEGOU. Para a admin: nada muda.


**22/09 15:55 vigia da esteira (ALARME)** -- a fatia k8_gerar_alertas caiu por vermelho DELA (construir falhou) -- nao relanco.


**22/09 15:55 vigia da esteira (ALARME)** -- trava A (estrutural) vazia: nenhuma fatia viva, nova ou para relancar na fila.


**22/09 16:00 vigia da esteira** -- vigia relancou painel_previsto_celula as 16:00 (baseline divergiu: a arvore andou depois do teste da fatia). Para a admin: nada muda.


**22/09 16:05 vigia da esteira (ALARME)** -- trava A (estrutural) vazia: nenhuma fatia viva, nova ou para relancar na fila.


**22/09 16:10 vigia da esteira (ALARME)** -- a fatia score_fmcomp esta PRONTA ha 103 min e nao esta na fila de integracao: trabalho terminado que ninguem vai buscar. Se ela tem portao, o fatia.done tem de DIZER qual; se nao tem, reentregue com bin/entregar.sh..


**22/09 16:20 vigia da esteira (ALARME)** -- a fatia fila_prazo_juiz caiu por vermelho DELA (GREEN parcial vermelho) -- nao relanco.


**22/09 16:20 vigia da esteira (ALARME)** -- trava A (estrutural) vazia: nenhuma fatia viva, nova ou para relancar na fila.


**22/09 16:25 vigia da esteira (ALARME)** -- a fatia k8_gerar_alertas esta PRONTA ha 76 min e nao esta na fila de integracao: trabalho terminado que ninguem vai buscar. Se ela tem portao, o fatia.done tem de DIZER qual; se nao tem, reentregue com bin/entregar.sh..


**22/09 16:40 vigia da esteira (ALARME)** -- a fatia score_fmcomp esta PRONTA ha 133 min e nao esta na fila de integracao: trabalho terminado que ninguem vai buscar. Se ela tem portao, o fatia.done tem de DIZER qual; se nao tem, reentregue com bin/entregar.sh..


**22/09 16:45 vigia da esteira (ALARME)** -- a fatia dash_turnos_juiz esta PRONTA ha 25 min e nao esta na fila de integracao: trabalho terminado que ninguem vai buscar. Se ela tem portao, o fatia.done tem de DIZER qual; se nao tem, reentregue com bin/entregar.sh..


**22/09 16:45 vigia da esteira** -- vigia relancou dash_turnos_juiz as 16:45 (baseline divergiu: a arvore andou depois do teste da fatia). Para a admin: nada muda.


**22/09 16:50 vigia da esteira (ALARME)** -- trava A (estrutural) vazia: nenhuma fatia viva, nova ou para relancar na fila.


**22/09 16:55 vigia da esteira (ALARME)** -- a fatia k8_gerar_alertas esta PRONTA ha 106 min e nao esta na fila de integracao: trabalho terminado que ninguem vai buscar. Se ela tem portao, o fatia.done tem de DIZER qual; se nao tem, reentregue com bin/entregar.sh..


**22/09 17:10 vigia da esteira (ALARME)** -- a fatia score_fmcomp esta PRONTA ha 163 min e nao esta na fila de integracao: trabalho terminado que ninguem vai buscar. Se ela tem portao, o fatia.done tem de DIZER qual; se nao tem, reentregue com bin/entregar.sh..


**22/09 17:15 vigia da esteira (ALARME)** -- trava A (estrutural) vazia: nenhuma fatia viva, nova ou para relancar na fila.


**22/09 17:25 vigia da esteira (ALARME)** -- a fatia tv_turnos_juiz esta PRONTA ha 43 min e nao esta na fila de integracao: trabalho terminado que ninguem vai buscar. Se ela tem portao, o fatia.done tem de DIZER qual; se nao tem, reentregue com bin/entregar.sh..


**22/09 17:25 vigia da esteira** -- vigia relancou tv_turnos_juiz as 17:25 (baseline divergiu: a arvore andou depois do teste da fatia). Para a admin: nada muda.


**22/09 17:30 vigia da esteira (ALARME)** -- a fatia k8_gerar_alertas esta PRONTA ha 141 min e nao esta na fila de integracao: trabalho terminado que ninguem vai buscar. Se ela tem portao, o fatia.done tem de DIZER qual; se nao tem, reentregue com bin/entregar.sh..


**22/09 17:30 vigia da esteira (ALARME)** -- a fatia reabrir_pend_viva esta PRONTA ha 47 min e nao esta na fila de integracao: trabalho terminado que ninguem vai buscar. Se ela tem portao, o fatia.done tem de DIZER qual; se nao tem, reentregue com bin/entregar.sh..


**22/09 17:30 vigia da esteira** -- vigia relancou reabrir_pend_viva as 17:30 (baseline divergiu: a arvore andou depois do teste da fatia). Para a admin: nada muda.


**22/09 17:35 vigia da esteira (ALARME)** -- trava A (estrutural) vazia: nenhuma fatia viva, nova ou para relancar na fila.


**22/09 17:45 vigia da esteira (ALARME)** -- a fatia score_fmcomp esta PRONTA ha 198 min e nao esta na fila de integracao: trabalho terminado que ninguem vai buscar. Se ela tem portao, o fatia.done tem de DIZER qual; se nao tem, reentregue com bin/entregar.sh..


**22/09 17:45 vigia da esteira** -- vigia relancou reabrir_pend_viva as 17:45 (baseline divergiu: a arvore andou depois do teste da fatia). Para a admin: nada muda.


**22/09 17:50 vigia da esteira (ALARME)** -- a fatia fio_msgs_competencia esta PRONTA ha 37 min e nao esta na fila de integracao: trabalho terminado que ninguem vai buscar. Se ela tem portao, o fatia.done tem de DIZER qual; se nao tem, reentregue com bin/entregar.sh..
