...
_Estado de 22/09 19:5x (placar regerado por `bin/placar_code.sh` as 19:4x, sobre a suite de 7.768 testes que carimbou OK as 18:38; balao e fila de trabalho seguem da lavra de 18/09 -- sao contadores da operacao, nao do Code). Publico: so ids e contagens, nunca nome/CPF, nenhum codigo._
...
| **leitores_narnia** (telas que contam por conta propria) | **144** (era 153 as 11h) | 0 | Code |
