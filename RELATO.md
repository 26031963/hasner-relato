...
_Estado de 23/09 03:0x (placar regerado por `bin/placar_code.sh` as 02:5x, sobre a suite de 7.811 testes que carimbou OK as 01:26; balao e fila de trabalho seguem da lavra de 18/09 -- sao contadores da operacao, nao do Code). Publico: so ids e contagens, nunca nome/CPF, nenhum codigo._
